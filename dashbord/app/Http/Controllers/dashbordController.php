    ...
    public function chart(){
      ...
      public function enregistrer(Request $request){
        ...
        //   // reviens sur la meme page ou il y a le formulaire et affiche le message
              return redirect('/')->with("success","personne ajouter avec succès");
          }
...
public function ajour(Request $request,$id){
    ...
    return redirect('/')->with("success","mis a jour effectuer avec succes");
...
public function loginuser(Request $request){
    ...
    if ($utilisateurs) {
       if (Hash::check( $request->Mot_de_passe, $utilisateurs->Mot_de_passe)) {
            $request->session()->put('loginId',$utilisateurs->id );
            return redirect('/');
       } else {
